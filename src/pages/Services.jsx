    ...
    <>
      ...
      <div className="page-wrapper">
        <ServiceCard
          ...
          description="Thai Yoga is an ancient form of bodywork originating from India though widely practiced in Thailand. This form of bodywork resembles its yogic roots offering stretching, rocking, breathwork, and compression following the energy lines of the body much like Acupuncture."
          image={thaiImg}
        ...
        <ServiceCard
          ...
          description="Abhyanga is an Ayurvedic treatment focusing on balancing the energy of the body. We will do tongue and pulse diagnosis and mix a personal oil with essential oils, or infused oils for a full body treatment."
          image={abhyangaImg}
        ...
        <ServiceCard
          ...
          description="Abdominal detox bodywork based on Chinese meridian theory, works the fascia and pressure points of the belly to aid in full function of the organs and connective tissues of the back and spine."
          image={chiNeSangImg}
