...
export type PageBlocksEmbed = {
  ...
  newsletterFormId?: Maybe<Scalars['String']['output']>;
  newsletterIntro?: Maybe<Scalars['String']['output']>;
  newsletterAskName?: Maybe<Scalars['Boolean']['output']>;
  newsletterPlaceholder?: Maybe<Scalars['String']['output']>;
  newsletterNamePlaceholder?: Maybe<Scalars['String']['output']>;
  newsletterButtonLabel?: Maybe<Scalars['String']['output']>;
  newsletterSuccess?: Maybe<Scalars['String']['output']>;
  newsletterFinePrint?: Maybe<Scalars['String']['output']>;
  scheduleLimit?: Maybe<Scalars['Float']['output']>;
  scheduleEmptyText?: Maybe<Scalars['String']['output']>;
  scheduleLinkLabel?: Maybe<Scalars['String']['output']>;
...
export type PageBlocksEmbedFilter = {
  ...
  newsletterFormId?: InputMaybe<StringFilter>;
  newsletterIntro?: InputMaybe<StringFilter>;
  newsletterAskName?: InputMaybe<BooleanFilter>;
  newsletterPlaceholder?: InputMaybe<StringFilter>;
  newsletterNamePlaceholder?: InputMaybe<StringFilter>;
  newsletterButtonLabel?: InputMaybe<StringFilter>;
  newsletterSuccess?: InputMaybe<StringFilter>;
  newsletterFinePrint?: InputMaybe<StringFilter>;
  scheduleLimit?: InputMaybe<NumberFilter>;
  scheduleEmptyText?: InputMaybe<StringFilter>;
  scheduleLinkLabel?: InputMaybe<StringFilter>;
...
export type PageBlocksEmbedMutation = {
  ...
  newsletterFormId?: InputMaybe<Scalars['String']['input']>;
  newsletterIntro?: InputMaybe<Scalars['String']['input']>;
  newsletterAskName?: InputMaybe<Scalars['Boolean']['input']>;
  newsletterPlaceholder?: InputMaybe<Scalars['String']['input']>;
  newsletterNamePlaceholder?: InputMaybe<Scalars['String']['input']>;
  newsletterButtonLabel?: InputMaybe<Scalars['String']['input']>;
  newsletterSuccess?: InputMaybe<Scalars['String']['input']>;
  newsletterFinePrint?: InputMaybe<Scalars['String']['input']>;
  scheduleLimit?: InputMaybe<Scalars['Float']['input']>;
  scheduleEmptyText?: InputMaybe<Scalars['String']['input']>;
  scheduleLinkLabel?: InputMaybe<Scalars['String']['input']>;
